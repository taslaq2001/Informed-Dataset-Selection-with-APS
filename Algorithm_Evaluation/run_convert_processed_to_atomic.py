...
if __name__ == "__main__":
    ...
    parser.add_argument('--core', dest='core', type=int, required=False, default=30)
    parser.add_argument('--data_split_type', dest='data_split_type', type=str, required=False, default="random_cv")
    parser.add_argument('--num_folds', dest='num_folds', type=int, required=False, default=5)
    parser.add_argument('--valid_size', dest='valid_size', type=float, required=False, default=0.2)
