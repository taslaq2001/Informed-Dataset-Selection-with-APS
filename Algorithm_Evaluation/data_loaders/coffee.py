...
class coffee (Loader) :
    ...
    def load_from_file(source_path, user_column_name, item_column_name, rating_column_name, timestamp_column_name,
        ...
        file_path = f"{source_path}/simplified_coffee.csv"
        ...
        df = df.rename(columns={
            ...
            'feature': 'feature Str',
            'feature_second':'feature'
        })

        df = df.dropna(subset=[rating_column_name, timestamp_column_name])

        return df[[ user_column_name,item_column_name, rating_column_name,timestamp_column_name,'feature Str','feature']]
